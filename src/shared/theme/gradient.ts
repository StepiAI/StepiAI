...
export const softGradientCss = `linear-gradient(135deg, ${softGradient[0]} 0%, ${softGradient[1]} 100%)`;
export const voiceBackgroundCss =
  'linear-gradient(160deg, #EAF6FF 0%, #F3EEFC 45%, #FCEFF8 100%)';
